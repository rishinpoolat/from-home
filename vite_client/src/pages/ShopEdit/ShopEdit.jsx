        ...
        <div className="df ai-c fd-c"> 
            ...
            <div className='shopedit-container df ai-c fd-c'>
                <div>
                    ...
                    <button className="edit-button"><i class="fas edit-pen fa-pen"></i> edit</button>
                </div>
                <div>
                ...
                <div>
                    <input className="input"placeholder="Phon No"/>
                    <button className="edit-button"><i class="fas edit-pen fa-pen"></i> edit</button>
                </div>
                <div>
                ...
                <div>
                    <input className="input"placeholder="Banner"/>
                    <button className="edit-button"><i class="fas edit-pen fa-pen"></i> edit</button>
                </div>
                <div>
